...
let getGoatee = (fill, size) => {j|<svg fill="$fill" viewBox="0 0 64 64"><path d="M28.033 36.527C29.444 36.176 30.766 36 32 36s2.556.176 3.967.527A4 4 0 0 1 39 40.408v4.475a3 3 0 0 1-1.513 2.606C35.72 48.496 33.944 49 32.157 49c-1.807 0-3.666-.514-5.578-1.542A3 3 0 0 1 25 44.816v-4.408a4 4 0 0 1 3.033-3.881zm.019 1.492a2 2 0 0 0-1.462 1.926v2.485a3 3 0 0 0 1.846 2.769c1.282.534 2.504.801 3.668.801 1.15 0 2.338-.26 3.567-.781a3 3 0 0 0 1.829-2.762v-2.5a2 2 0 0 0-1.47-1.93 15.16 15.16 0 0 0-4.03-.565c-1.304 0-2.62.185-3.948.557z"/></svg>|j};
let getShadow = (fill, size) => {j|<svg fill="$fill" viewBox="0 0 64 64"><path d="M46 29v4c0 7.732-6.268 14-14 14s-14-6.268-14-14v-4c0-.1.001-.2.003-.298C20.048 31.642 22.535 35.669 26 37c2-1.003 4-1.504 6-1.504s4 .501 6 1.504c3.465-1.33 5.952-5.359 7.997-8.298.002.099.003.198.003.298z" opacity=".2"/></svg>|j};
let getSoulpatch = (fill, size) => {j|<svg fill="$fill" viewBox="0 0 64 64"><path d="M30 43.5h4l-.684 2.051a1.387 1.387 0 0 1-2.632 0z"/></svg>|j};
let getWalrus = (fill, size) => {j|<svg fill="$fill" viewBox="0 0 64 64"><path d="M29 35h6a5 5 0 0 1 5 5H24a5 5 0 0 1 5-5z"/></svg>|j};
...
|j};
let getLong = (fill, size) => {j|
<svg width="$size" height="$size" viewBox="0 0 64 64">
  <defs>
    <path fill="$fill" id="a" d="M44 26c-1.807-2.008-3.13-4.5-3.97-7.474-1.87 2.283-4.546 3.607-8.03 3.974-5.832.614-10.817-.327-14.953-2.822A13.959 13.959 0 0 0 16 25v1.027a4.474 4.474 0 0 0-2 .73V25.5C14 16.387 21.163 9 30 9s16 7.387 16 16.5v1.258a4.474 4.474 0 0 0-2-.73zm2 8.242v6.604c0 7.312-4.612 13.513-11 15.679V44.08a14.036 14.036 0 0 0 8.42-9.082l.08.001a4.48 4.48 0 0 0 2.5-.758zM25.13 56.568C18.675 54.443 14 48.208 14 40.846v-6.604a4.48 4.48 0 0 0 2.58.757A14.036 14.036 0 0 0 25 44.081v5.464c.051 2.356.095 4.697.13 7.023z"/>
    <mask id="b" fill="#fff"><use fill="none"/></mask>
  </defs>
  <g fill="none" transform="translate(2 2)">
    <use fill="#362c47"/>
    <path fill="#fff" d="M14 9h32v18H14z" mask="url(#b)" opacity=".258"/>
  </g>
</svg>
|j};
...
let getBeanie = (fill, size) => {j|<svg viewBox="0 0 64 64"><path fill="$fill" d="M18.996 21.804C21.059 16.644 26.104 13 32 13s10.94 3.645 13.004 8.804c.079.063.157.127.235.192a1 1 0 0 1 .338.54l.627 2.64a.5.5 0 0 1-.774.523C40.989 22.566 36.512 21 32 21c-4.513 0-8.985 1.567-13.417 4.702a.5.5 0 0 1-.775-.522l.616-2.64a1 1 0 0 1 .338-.546l.234-.19z"/><path d="M32 17c4.779 0 9.192 1.665 13.24 4.996a1 1 0 0 1 .337.54l.627 2.64a.5.5 0 0 1-.774.523C40.989 22.566 36.512 21 32 21c-4.513 0-8.985 1.567-13.417 4.702a.5.5 0 0 1-.775-.522l.616-2.64a1 1 0 0 1 .338-.546C22.81 18.664 27.222 17 32 17z" opacity=".255"/></svg>|j};
...
<svg viewBox="0 0 64 64">
  <g fill="none" transform="translate(18 8)">
    ...
    |j};
let getBuzz = (fill, size) => {j|<svg viewBox="0 0 64 64"><linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%"><stop offset="0"/><stop offset="1" stop-opacity="0"/></linearGradient><g fill="none"><path fill="url(#a)" d="M28 15v2c-1.323-3.514-3.06-5.389-3.759-6-1.048-.917-2.478-1.795-3.35-3.731-.57-1.268-.474-2.94-.393-4.673C24.958 4.937 28 9.613 28 15zM0 15v2c1.323-3.514 3.06-5.389 3.759-6 1.048-.917 2.478-1.795 3.35-3.731.57-1.268.474-2.94.393-4.673C3.042 4.937 0 9.613 0 15z" transform="translate(18 12)"/><path fill="#000" d="M27.977 13.226L40 12a6.838 6.838 0 0 1-6.487 9h-6.216a3 3 0 0 1-3-3v-.7a4.096 4.096 0 0 1 3.68-4.074z"/></g></svg>|j};
let getExtralong = (fill, size) => {j|
<svg viewBox="0 0 64 64"><defs><path id="a" d="M30 17c-1.807-2.008-3.13-4.5-3.97-7.474-1.87 2.283-4.546 3.607-8.03 3.974-5.832.614-10.817-.327-14.953-2.822A13.959 13.959 0 0 0 2 16v1.027a4.474 4.474 0 0 0-2 .73V16.5C0 7.387 7.163 0 16 0s16 7.387 16 16.5v1.258a4.474 4.474 0 0 0-2-.73zm2 8.242v22.283H21V35.08a14.036 14.036 0 0 0 8.42-9.082l.08.001a4.48 4.48 0 0 0 2.5-.758zM11.13 47.568H0V25.242A4.48 4.48 0 0 0 2.58 26 14.036 14.036 0 0 0 11 35.081v5.464c.034 1.57.078 3.912.13 7.023z"/><mask id="b" fill="#fff"><use fill="none"/></mask></defs><g fill="none" transform="translate(16 11)"><use fill="#000"/><path fill="#fff" d="M0 0h32v18H0z" mask="url(#b)" opacity=".258"/></g></svg>|j};
let getFade = (fill, size) => {j|
<svg viewBox="0 0 64 64"><linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%"><stop style="stop-color: $fill" offset="0"/><stop style="stop-color: $fill" offset="1" stop-opacity="0"/></linearGradient>
  <g fill="none">
...
|j};
let getMohawk = (fill, size) => {j|<svg viewBox="0 0 64 64"><g fill="none"><path fill="$fill" d="M32.034 10c2.746 0 4.217 1.437 4.842 2.052.563.54.968 1.313 1.112 2.14l.663 4.17c.354 1.942-.698 3.665-2.526 4.086C34.5 22.816 33.12 23 32 23c-1.132 0-2.553-.192-4.244-.576-1.832-.423-2.834-2.2-2.375-4.145l.786-4.2a3.972 3.972 0 0 1 1.035-1.932c.624-.642 2.086-2.147 4.832-2.147z"/><path fill="#fff" d="M36.876 12.052c.563.54.968 1.313 1.112 2.14l.663 4.17c.354 1.942-.698 3.665-2.526 4.086C34.5 22.816 33.12 23 32 23c-1.132 0-2.553-.192-4.244-.576-1.832-.423-2.834-2.2-2.375-4.145l.786-4.2a3.972 3.972 0 0 1 1.035-1.932c.26-.268.666-.686 1.25-1.082-.316.488-1.452.987-1.452 2.435V17c-.322 1.645.73 3.154 2.017 3.513 1.187.325 2.186.487 2.981.487.787 0 1.757-.156 2.898-.467 1.285-.356 2.352-1.89 2.104-3.533v-3c0-1.5-1.105-2.544-1.5-3a1.47 1.47 0 0 0-.136-.14c.726.42 1.215.9 1.512 1.192z" opacity=".257"/></g></svg>|j};
let getShortcomboverchops = (fill, size) => {j|<svg viewBox="0 0 64 64"><g fill="none"><path fill="$fill" d="M17.79 27.558l-.712-6.59A9 9 0 0 1 26.025 11H43a9.237 9.237 0 0 1-.74 3.63 7.926 7.926 0 0 1 4.6 8.351L46 29l-.002-.001v4.222a14.005 14.005 0 0 1-.476 3.42l-2.523.539a1 1 0 0 1-1.188-1.182l1.899-9.114c-1.574-2.093-2.678-5.242-3.314-9.445a9.238 9.238 0 0 1-5.692 2.774c-1.823.191-3.391.287-4.704.287-3 0-5.667-.5-8-1.5 0 2.59-.666 5.098-1.997 7.523l1.974 9.475a1 1 0 0 1-1.188 1.182l-2.522-.538a14.005 14.005 0 0 1-.477-3.421z"/><path fill="#fff" d="M20.003 26.523l1.974 9.475a1 1 0 0 1-1.188 1.182l-2.522-.538a14.005 14.005 0 0 1-.477-3.421v-5.664l-.712-6.59A9 9 0 0 1 26.025 11H43a9.237 9.237 0 0 1-2.604 6.439 9.238 9.238 0 0 1-5.692 2.774c-1.823.191-3.391.287-4.704.287-3 0-5.667-.5-8-1.5 0 2.59-.666 5.098-1.997 7.523zm25.995 2.476v4.222a14.005 14.005 0 0 1-.476 3.42l-2.523.539a1 1 0 0 1-1.188-1.182l1.899-9.114c-1.149-1.528-2.047-3.618-2.696-6.27a9.288 9.288 0 0 0 3.45-4.506 7.91 7.91 0 0 1 2.396 6.873L46 29z" opacity=".259"/></g></svg>|j};
...
let getStraightbun = (fill, size) => {j|<svg viewBox="0 0 64 64"><g fill="none"><path fill="$fill" d="M22.2 17.002c-.131-.647-.2-1.316-.2-2.002 0-5.523 4.477-10 10-10s10 4.477 10 10c0 .686-.069 1.355-.2 2.002C39.274 14.526 35.815 13 32 13s-7.274 1.526-9.8 4.002z"/><path fill="#f55d81" d="M45.934 25.632C43.828 20.564 38.83 17 33 17h-2c-5.83 0-10.828 3.564-12.934 8.632C18.753 18.542 24.73 13 32 13s13.247 5.542 13.934 12.632z"/></g></svg>|j};
