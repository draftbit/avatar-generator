    ...
    <>
      ...
      <main className="Layout-main">
        <AvatarGenerator
          ...
          nose
          bgColor
          skinStyles={List.fromArray(skinStyles)}
          hairStyles={List.fromArray(hairStyles)}
          facialHairStyles={List.fromArray(facialHairStyles)}
          bodyStyles={List.fromArray(bodyStyles)}
          eyeStyles={List.fromArray(eyeStyles)}
          noseStyles={List.fromArray(noseStyles)}
          mouthStyles={List.fromArray(mouthStyles)}
          bgStyles={List.fromArray(bgStyles)}
          skinColors={List.fromArray(skinColors)}
          hairColors={List.fromArray(hairColors)}
          facialHairColors={List.fromArray(facialHairColors)}
          bodyColors={List.fromArray(bodyColors)}
          bgColors={List.fromArray(bgColors)}
          disabledColors={List.fromArray(disabledColors)}
          onChange
          onExport
        />
      </main>
