let getBackground = (fill, size) =>
  j`<svg height="$size" width="$size" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="m0 0h64v64h-64z" fill="$fill"/></svg>`
let getBeardMustache = (fill, size) =>
  j`
...
`
let getMustache = (fill, size) =>
  j`<svg fill="$fill" height="$size" width="$size" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"> <path d="M32.016 38.05a2.718 2.718 0 0 1-3.182 1.587l-5.082-1.3a1 1 0 0 1-.075-1.916l5.235-1.786a2.504 2.504 0 0 1 3.104 1.37 2.504 2.504 0 0 1 3.105-1.37l5.235 1.786a1 1 0 0 1-.075 1.915l-5.082 1.3a2.717 2.717 0 0 1-3.183-1.587z" /></svg>`
let getGoatee = (fill, size) =>
  j`<svg width="$size" height="$size" fill="$fill" viewBox="0 0 64 64"><path d="M28.033 36.527C29.444 36.176 30.766 36 32 36s2.556.176 3.967.527A4 4 0 0 1 39 40.408v4.475a3 3 0 0 1-1.513 2.606C35.72 48.496 33.944 49 32.157 49c-1.807 0-3.666-.514-5.578-1.542A3 3 0 0 1 25 44.816v-4.408a4 4 0 0 1 3.033-3.881zm.019 1.492a2 2 0 0 0-1.462 1.926v2.485a3 3 0 0 0 1.846 2.769c1.282.534 2.504.801 3.668.801 1.15 0 2.338-.26 3.567-.781a3 3 0 0 0 1.829-2.762v-2.5a2 2 0 0 0-1.47-1.93 15.16 15.16 0 0 0-4.03-.565c-1.304 0-2.62.185-3.948.557z"/></svg>`
let getShadow = (fill, size) =>
  j`<svg width="$size" height="$size" fill="$fill" viewBox="0 0 64 64"><path d="M46 29v4c0 7.732-6.268 14-14 14s-14-6.268-14-14v-4c0-.1.001-.2.003-.298C20.048 31.642 22.535 35.669 26 37c2-1.003 4-1.504 6-1.504s4 .501 6 1.504c3.465-1.33 5.952-5.359 7.997-8.298.002.099.003.198.003.298z" opacity=".2"/></svg>`
let getSoulpatch = (fill, size) =>
  j`<svg width="$size" height="$size" fill="$fill" viewBox="0 0 64 64"><path d="M30 43.5h4l-.684 2.051a1.387 1.387 0 0 1-2.632 0z"/></svg>`
let getWalrus = (fill, size) =>
  j`<svg width="$size" height="$size" fill="$fill" viewBox="0 0 64 64"><path d="M29 35h6a5 5 0 0 1 5 5H24a5 5 0 0 1 5-5z"/></svg>`

let getEyesGlasses = (_, size) =>
...
let getEyesOpen = (_, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="$size" d="M25.5 30a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm13 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/></svg>`
let getEyesSleepy = (fill, size) =>
...
let getEyesSunglasses = (fill, size) =>
...
let getEyesWink = (fill, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="$fill" d="M25.5 30a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm14.907-2.744a.75.75 0 0 1 .186 1.488l-4 .5a.75.75 0 0 1-.186-1.488z"/></svg>`

let getMouthBigsmile = (_, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="#1b0640" d="M29 38h6v1a3 3 0 0 1-6 0z"/></svg>`
let getMouthFrown = (_, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="#1b0640" d="M28.004 40.132a1 1 0 0 0 .992 1.736C30.016 41.285 31.014 41 32 41s1.983.285 3.004.868a1 1 0 1 0 .992-1.736C34.684 39.382 33.348 39 32 39c-1.348 0-2.684.382-3.996 1.132z"/></svg>`
let getMouthLips = (_, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><g fill="none"><path fill="#dc5c7a" d="M28 41h8c-.667 1.667-2 2.5-4 2.5s-3.333-.833-4-2.5z"/><path fill="#f57b98" d="M32 40a2.092 2.092 0 0 1 3.612.225L36 41h-8l.388-.775A2.092 2.092 0 0 1 32 40z"/></g></svg>`
let getMouthPacifier = (_, size) =>
...
let getMouthSmile = (_, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="#1b0640" d="M28.004 41.868a1 1 0 0 1 .992-1.736c1.02.583 2.018.868 3.004.868s1.983-.285 3.004-.868a1 1 0 1 1 .992 1.736C34.684 42.618 33.348 43 32 43c-1.348 0-2.684-.382-3.996-1.132z"/></svg>`
let getMouthSmirk = (_, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="#1b0640" d="M30.318 41.728a.75.75 0 0 1 .364-1.456c2.433.609 4.165.32 5.288-.802a.75.75 0 0 1 1.06 1.06c-1.544 1.545-3.812 1.923-6.712 1.198z"/></svg>`
let getMouthSurprise = (_, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><ellipse cx="32" cy="41" fill="#1b0640" rx="2" ry="2.5"/></svg>`

let getNoseMediumround = (fill, size) =>
  j`
...
let getNoseSmallround = (fill, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><g fill="none"><path fill="$fill" d="M29.288 35.237a.75.75 0 0 1 .475-.949 1.09 1.09 0 0 1 .307-.028H33.92c.133 0 .263.01.317.028a.75.75 0 0 1 .475.95c-.434 1.3-1.383 2.012-2.712 2.012s-2.278-.712-2.712-2.013z"/>
...
`
let getBodyOval = (fill, size) =>
  j`<svg height="$size" width="$size" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><g fill="$fill" fill-rule="nonzero" transform="translate(21 46)"><path d="m22 18h-22v-8c0-4.27468547 2.43832409-7.97986983 6-9.80058081v1.80058081c0 2.76142375 2.23857625 5 5 5 2.7614237 0 5-2.23857625 5-5v-1.80058081c3.5616759 1.82071098 6 5.52589534 6 9.80058081z"/><path d="m22 18h-22v-8c0-4.27468547 2.43832409-7.97986983 6-9.80058081v1.80058081c0 2.76142375 2.23857625 5 5 5 2.7614237 0 5-2.23857625 5-5v-1.80058081c3.5616759 1.82071098 6 5.52589534 6 9.80058081z"/></g></svg>`
let getBodyRound = (fill, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="$fill" d="M27 51v.47a5 5 0 0 0 10 0V51c7.063 1.523 12.93 6.735 16 13H11c3.07-6.265 8.937-11.477 16-13z"/></svg>`
let getBodySquare = (fill, size) =>
  j`<svg width="$size" height="$size" viewBox="0 0 64 64"><path fill="$fill" d="M27 49v3a5 5 0 0 0 10 0v-3l6.647 2.045A9 9 0 0 1 50 59.647V64H14v-4.353a9 9 0 0 1 6.353-8.602z"/></svg>`
...
let getBuzzcut = (fill, size) =>
  j`<svg style="mix-blend-mode: multiply;" width="$size" height="$size" viewBox="0 0 64 64"><path fill="$fill"  d="M46 27v3c-1.333-1.667-2.667-4.667-4-9-2.657 1.333-5.99 2-10 2s-7.343-.667-10-2c-1.333 3.667-2.667 6.333-4 8v-2c0-7.732 6.268-14 14-14s14 6.268 14 14z"/></svg>`
...
let getShortcombover = (fill, size) =>
...
let getShortcomboverchops = (fill, size) =>
...
let make = (~style=?, ~className="", ~name, ~fill="#000", ~size="64") => {
  ...
  getHtml(name) == ""
    ? React.null
    : <div className ?style dangerouslySetInnerHTML={"__html": getHtml(name)} />
}
