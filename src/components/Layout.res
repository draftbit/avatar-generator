...
let meta = [
  MetaWithName("description", "A playful avatar generator for the modern age."),
  MetaWithName("twitter:card", "summary"),
  MetaWithName("twitter:site", "@draftbit"),
  MetaWithName("twitter:title", "Personas by Draftbit"),
  MetaWithName("twitter:image", "https://personas.draftbit.com/web-preview-1x1.png"),
  MetaWithName("twitter:description", "A playful avatar generator for the modern age."),
  MetaWithName("keywords", "Avatar, Avatar Generator, Personas, Draftbit, Avatars"),
  MetaWithProperty("fb:app_id", "292869531545861"),
  MetaWithProperty("og:type", "website"),
  MetaWithProperty("og:image", "https://personas.draftbit.com/web-preview.png"),
  MetaWithProperty("og:title", "Personas by Draftbit"),
  MetaWithProperty("og:url", "https://personas.draftbit.com"),
  MetaWithProperty("og:description", "A playful avatar generator for the modern age."),
]
...
let metaToHelmet = (item: metaItem) =>
  ...
  | MetaWithProperty(property, content) => finalMetaItem(~property, ~content, ())
  }
...
let make = (~children: React.element) => {
  ...
  <>
    <Helmet title=data.site.siteMetadata.title link meta={meta |> Array.map(metaToHelmet)}>
      <html lang="en" />
    </Helmet>
    children
  </>
